...
export default function Experiencia() {
    return (
        <section className="md:w-[90%] my-16 lg:grid grid-cols-2 lg:gap-4 mx-auto px-4 md:flex md:flex-col md:gap-4">
            ...
            {experiencia.map((item, index) => (
                <BackgroundGradient key={index} className="rounded-[22px] p-8 dark:bg-zinc-900  :h-full">
